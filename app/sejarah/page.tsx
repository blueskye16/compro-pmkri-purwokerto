          ...
          <article className="prose prose-lg mb-14 max-w-none text-slate-700">
            <FadeIn>
              <p className="text-xl leading-relaxed font-light text-slate-600">
                ...
                dari fusi antara Federasi Katholieke Studenten Vereniging (KSV)
                dan PMKRI Yogyakarta pada 11 Juni 1950. Namun, hari lahirnya
                secara historis ditetapkan pada{" "}
            ...
            <FadeIn>
              ...
              <ul className="mt-4 list-disc space-y-2 pl-6 marker:text-red-900">
                <li>
                  ...
                  salah satu pelopor berdirinya Kesatuan Aksi Mahasiswa
                  Indonesia (KAMI) yang melahirkan Tiga Tuntutan Rakyat
                  (Tritura).
                </li>
                <li>
                  <strong className="text-slate-900">1972:</strong> Turut
                  membidani lahirnya forum komunikasi Kelompok Cipayung bersama
                  HMI, GMKI, GMNI, dan PMII sebagai kekuatan kontrol sosial.
                </li>
                <li>
                  <strong className="text-slate-900">1998:</strong> Terlibat
            ...
            <FadeIn>
              <div className="mt-14 rounded-xl border border-red-200 bg-red-50 p-6 shadow-sm">
