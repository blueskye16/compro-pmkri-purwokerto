          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="flex flex-col justify-center">
              <FadeIn className="mb-6">
                ...
                <h1 className="mt-2 font-serif text-4xl leading-tight font-bold text-red-900 md:text-5xl lg:text-6xl">
                  Keluar dari <br />
                  <span className="text-slate-800 italic">Zona Nyaman.</span>
                </h1>
              </FadeIn>
              ...
              <div className="mb-10 space-y-6">
                <FadeIn>
                  <div className="flex items-start gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-red-100 text-red-900">
                      <Flame size={20} />
                    </div>
                    <div>
